...
local bronzeScore = newImage('bronzeScore', 'imagens/bronzetrophy.png')
local silverScore = newImage('silverScore', 'imagens/silvertrophy.png')
local goldScore = newImage('goldScore', 'imagens/goldtrophy.png')
...
function ScoreState:render()
    ...
    if self.score >= goldTrophy then
        draw('goldScore', VIRTUAL_WIDTH / 2 - goldScore:getWidth() / 2, VIRTUAL_HEIGHT / 2 - goldScore:getHeight() / 2)
    elseif self.score >= silverTrophy and self.score < goldTrophy then
        draw('silverScore', VIRTUAL_WIDTH / 2 - silverScore:getWidth() / 2, VIRTUAL_HEIGHT / 2 - silverScore:getHeight() / 2)
    elseif self.score >= bronzeTrophy and self.score < silverTrophy then
        draw('bronzeScore', VIRTUAL_WIDTH / 2 - bronzeScore:getWidth() / 2, VIRTUAL_HEIGHT / 2 - bronzeScore:getHeight() / 2)
    end
